...
$( "#kw_button" ).click(function() {
		     ...
		     $(document.getElementById("GRAPH1","GRAPH2","GRAPH3")).hide()
...
function reqListener () {
   ...
   //
		...
		$( "#ws_button" ).click(function() {
		     $(document.getElementById("GRAPH1")).hide()
		 });
		$( "#ws_button" ).click(function() {
    		 $(document.getElementById("GRAPH2")).hide()
		 });
		$( "#ws_button" ).click(function() {
  		   $(document.getElementById("GRAPH3")).hide()
 		});
