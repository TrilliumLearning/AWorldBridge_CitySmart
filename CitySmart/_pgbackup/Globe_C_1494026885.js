...
//Depending on the version of javascript there might be a problem.
    e[0].innerHTML =
        `\<h3 color="black">  Site Name: ` + Globe_siteName[index_num] + `\</h3>
        <img src=".\\Pics\\` + Globe_pictureLocation[index_num] + `"/>
        \<h6 color="black">Copyright: ` + Globe_copyright[index_num] + `\</h6>
		<br>
		<br>
        <h6 color="black">` + Globe_siteDescription[index_num] + `\</h6>
		<br>
        <h6 color="black">Latitude and Longitude: ` + Globe_latitude_longitude[index_num] + `\</h6>
		<br>
		<h6 color="black">Site Link: <a style="color: rgb(0, 136, 234)" href="` + Globe_linkToSiteLocation[index_num] + `">` + Globe_linkToSiteLocation[index_num] + ` </a>\</h6>
...
var Globe_url = "http://localhost:40002/file:///Users/kshin/Desktop/CitySmart/Layer_Files/Layer_csv/Master.csv";
