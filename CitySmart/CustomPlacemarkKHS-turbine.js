        ...
        var handlePick = function (o) {
            ...
            if (pickList.objects.length > 0) {
                for (var p = 0; p < pickList.objects.length; p++) {
                    ...
                    if (pickList.objects[p].position.latitude === 57.793083 && pickList.objects[p].position.longitude === -152.397157)
                    {
                        toggle_visibility('KodiakPopupBoxPosition');
